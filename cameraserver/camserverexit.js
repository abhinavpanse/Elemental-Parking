...
let image_url = "http://192.168.137.203:8080/shot.jpg";
let image_dest = "D:/carexit.jpg";
      ...
      .then(json => {
        ...
        try {
          ...
          if (currcar != prevcar) {
            ...
            console.log(currcar);
            prevcar = currcar;
            const our_main_server = "http://localhost:5000/api/parkinglot/exit";
            var data = { carnumber: currcar };
            console.log("car on exit => " + carnumber);
            fetch(our_main_server, {
              ...
              .then(res => res.json())
              .then(response =>
                console.log("Success Exit: ", JSON.stringify(response))
              )
...
console.log("Exit Camera server started...");
demo();
